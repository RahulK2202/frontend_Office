...
function MeetingTable() {
  ...
  const pageCount = Math.ceil(meeting.length / itemsPerPage);
  const displayedMeetings = meeting.slice(
              ...
              <tbody>
                {displayedMeetings.map((meeting) => (
                  <tr key={meeting.id}>
                    ...
                    <td className="border px-4 py-2">{meeting.organizer_details.username}</td>
